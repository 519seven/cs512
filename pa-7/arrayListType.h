...
class arrayListType {
 public:
    ...
    virtual void insertAt(int location, const Type& insertItem) = 0;
    ...
    virtual void insertEnd(const Type& insertItem, const bool force) = 0;
    ...
    void retrieveAt(int location, const Type& retItem) const;
    ...
    virtual void replaceAt(int location, const Type& repItem) = 0;
    ...
    virtual int seqSearch(const Type& searchItem) = 0;
    ...
    virtual void remove(const Type& removeItem) = 0;
