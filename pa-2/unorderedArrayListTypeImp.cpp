...
bool unorderedArrayListType::isEmpty() const {
    return (length == 0);
}  // end isEmpty

bool unorderedArrayListType::isFull() const {
    return (length == maxSize);
}  // end isFull

int unorderedArrayListType::listSize() const {
    return length;
}  // end listSize

int unorderedArrayListType::maxListSize() const {
    return maxSize;
}  // end maxListSize
...
bool unorderedArrayListType::isItemAtEqual(int location, int item)  const {
...
void unorderedArrayListType::retrieveAt(int location, int& retItem) const {
    if (location < 0 || location >= length)
...
void unorderedArrayListType::clearList() {
    length = 0;
}  // end clearList
...
unorderedArrayListType::unorderedArrayListType
                (const unorderedArrayListType& otherList) {
